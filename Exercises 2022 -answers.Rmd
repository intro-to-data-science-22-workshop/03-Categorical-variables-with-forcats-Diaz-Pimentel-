...
In general, income levels are in the order. But, let's supposed that we work with a reshuffled income.
...
ggplotprueba <- ggplot(gss_cat, aes(x = fct_infreq(rincome))) + 
    geom_bar() + 
    coord_flip() 
ggplotprueba
